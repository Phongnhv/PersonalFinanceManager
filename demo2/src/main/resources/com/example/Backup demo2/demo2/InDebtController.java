...
public class InDebtController {
    ...
    public boolean DeleteSavingFromDatabase(){
        ...
        //TODO add to Income list when saving is done
    ...
    //TODO complete setObjFormAppearance when init automatically
    //TODO add Delete, complete, addMoney to objective from database
    ...
    ******************/
    ...
    public void Paid(){
        ...
        //TODO add new expense data to the expense
        String Sql = "INSERT INTO expense (Purpose, Category, Amount, Date, Description, username) VALUES (?,?,?,?,?,?)";

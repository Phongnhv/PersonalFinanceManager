...
public class dashboardController implements Initializable {
    ...
    @FXML
    private Button Income_submitBtn;

    @FXML
    private TableView<IncomeData> Income_table;

    @FXML
    private FontAwesomeIcon dashboard_close;
    ...
    public void addEventManually() throws IOException {
        ...
        addNewDebtPane.setOnMouseClicked(mouseEvent -> {
            ...
            if (SelectedAnchorPane == finalN){
                //System.out.println(SelectedInDebtController.getKey());
    ...
    @FXML
    private Button Home_next_left, Home_next_right;
    ...
    public void HomeDisplayShoppingExpense(){
        ...
        try{
            ...
            Home_shopping.setText(String.valueOf(count));
        }catch (Exception e){
            e.printStackTrace(System.out);
        }
    ...
    public void HomeDisplayEntertainmentExpense(){
        ...
        try {
            ...
            Home_fooddrink.setText(String.valueOf(num));
        }catch (Exception e){
            e.printStackTrace(System.out);
        }
    }
    ...
    public void HomeDisplayBills(){
        ...
        try {
            ...
            Home_bills.setText(String.valueOf(num));
        }catch (Exception e){
            e.printStackTrace(System.out);
        }
    }
    ...
    public void HomeDisplayOthers(){
        ...
        try {
            ...
            Home_others.setText(String.valueOf(num));
        }catch (Exception e){
            e.printStackTrace(System.out);
        }
    }
    ...
    public void HomeDisplayMyBalance(){
        ...
        Home_balance.setText(String.valueOf(countIncome - countExpense));
        if (countIncome-countExpense > 10000){
            Home_balance.setFont(Font.font("Tahoma", FontWeight.BOLD,20));
        }
    }
    ...
    *******************/
    ...
    @FXML
    private Button Income_sortingBtn;
